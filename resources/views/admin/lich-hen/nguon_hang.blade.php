                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                @if (isset($lichHensTodo))
                                                                    ...
                                                                    <div class="modal-body p-4">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="datetime-local"
                                                                                name="thoi_gian_hen" class="form-control"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center py-4 text-muted">Không có nhiệm vụ cần
                                                xử
                                                lý.</td>
                                        </tr>
                                    @endforelse
                        ...
                        @if (isset($lichHensTodo))
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <div class="small">
                                                <span class="text-muted"><i class="fas fa-user-tag me-1"></i> Sale
                                                    hẹn:</span>
                                                <strong
                                                    class="text-dark">{{ $lh->nhanVienSale->ho_ten ?? 'N/A' }}</strong>
                                            </div>
                                        </div>
                            ...
                            @empty
                                <div class="text-center py-5">
                                    <i class="fas fa-check-double text-success mb-3 opacity-25"
