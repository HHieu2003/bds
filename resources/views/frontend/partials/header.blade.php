    ...
    <div class="container mx-4" style="max-width: 100%">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center fw-semibold">
                ...
                {{-- Giới thiệu --}}
                <li class="nav-item">
                    <a class="nav-link px-3 {{ request()->routeIs('about') ? 'active text-primary' : '' }}"
                        href="{{ route('about') }}">
                        Giới thiệu
                    </a>
                </li>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link px-3 dropdown-toggle {{ request()->routeIs('du-an.*') ? 'active text-primary' : '' }}"
                        href="{{ route('du-an.index') }}" id="duAnDropdown" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        Dự Án
                    </a>
                    <ul class="dropdown-menu border-0 shadow mt-2" aria-labelledby="duAnDropdown">
                        ...
                        <li>
                            <a class="dropdown-item fw-bold text-primary py-2"
                                href="{{ route('du-an.index') }}?khu_vuc=smart-city">
                        ...
                        {{-- Các khu vực khác --}}
                        <li><a class="dropdown-item py-2" href="{{ route('du-an.index') }}?khu_vuc=khac">Khu vực Tây
                                Mỗ</a></li>
                        <li><a class="dropdown-item py-2" href="{{ route('du-an.index') }}?khu_vuc=khac">Khu vực Đại
                                Mỗ</a></li>
                ...
                {{-- Tin tức --}}
                <li class="nav-item">
                    <a class="nav-link px-3 {{ request()->routeIs('bai-viet.*') ? 'active text-primary' : '' }}"
                        href="{{ route('bai-viet.index') }}">
                        Tin Tức
                    </a>
                </li>
                ...
                <li class="nav-item ms-lg-3 border-start ps-lg-3 d-flex align-items-center mt-3 mt-lg-0">
                    ...
                    {{-- Nút Yêu thích --}}
                    <a class="nav-link position-relative me-3" href="{{ route('yeu-thich.index') }}"
                        title="Tin đã lưu">
                    ...
                    @if (Auth::guard('customer')->check())
                        <div class="dropdown">
                            <a class="nav-link dropdown-toggle d-flex align-items-center p-0 text-dark" href="#"
                                id="userDropdown" role="button" data-bs-toggle="dropdown">
                                <div class="bg-light rounded-circle d-flex align-items-center justify-content-center text-primary fw-bold border"
                                    style="width: 36px; height: 36px;">
                                    {{ substr(Auth::guard('customer')->user()->ho_ten ?? 'U', 0, 1) }}
                                </div>
                                <span
                                    class="ms-2 d-none d-lg-block small fw-bold">{{ Auth::guard('customer')->user()->ho_ten }}</span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end border-0 shadow mt-2"
                                aria-labelledby="userDropdown">
                                <li><a class="dropdown-item" href="{{ route('yeu-thich.index') }}"><i
                                            class="fas fa-heart me-2 text-danger"></i>Tin đã lưu</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li>
                    ...
                    @else
                        <a href="#" class="fw-bold text-decoration-none small text-primary" data-bs-toggle="modal"
                            data-bs-target="#modalQuickLogin">
                            Đăng nhập
                        </a>
                    @endif
                </li>
