...
@section('content')
    ...
    <div class="container py-5">
        <div class="row g-4">
            @foreach($duAn as $index => $item)
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                <div class="card border-0 rounded-4 shadow h-100 project-card">
                    <a href="{{ route('project.show', $item->id) }}" class="overflow-hidden rounded-top-4">
                    ...
                    <div class="card-body">
                        <h4 class="fw-bold mb-2 serif-font"><a href="{{ route('project.show', $item->id) }}" class="text-dark text-decoration-none">{{ $item->ten_du_an }}</a></h4>
                        ...
                        <div class="d-flex justify-content-between border-top pt-3">
                            ...
                            <a href="{{ route('project.show', $item->id) }}" class="fw-bold text-primary text-decoration-none">Xem ngay <i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-5 d-flex justify-content-center">{{ $duAn->links() }}</div>
    </div>
@endsection